...
var AvocatModel = require('../models/avocats')
...
router.post('/sign-in', async function(req, res, next) {
  ...
  var user = await AvocatModel.find({ email: req.body.signInEmail, password: req.body.signInPassword })
  if(user.length > 0){
...
router.put('/sign-up', async function(req, res, next) {
  ...
  router.put('avocats/sign-up', async function(req, res, next) {
